...
app.get("/list", function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var db, notes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                db = _a.sent();
                return [4 /*yield*/, (0, noteService_1.getNotes)(db)];
            case 2:
                notes = _a.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, noteService_1.createNote)(db, { title: title, body: body })];
            case 2:
                _b.sent();
